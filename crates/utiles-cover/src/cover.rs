...
//             line_string_cover(&mut tilescoverage, &coords, zoom, None);
//         }
//
...
//           // }
//           // geo_types::Geometry::GeometryCollection(gjcoll) => {
//           //     for geom in gjcoll.geometries() {
//           //         let recurse_res = geometry2tiles(geom, zoom, minzoom)?;
//           //         tilescoverage.extend(recurse_res);
//           //     }
//           // }
//     }
//     // let tiles = geom2tiles(geom, zoom)?;
//     // match minzoom {
//     //     Some(z) => {
//     //         debug!("minzoom: {}", z);
...
//     //         Ok(cov)
//     //     }
//     //     None => Ok(tiles.into_iter().collect()),
//     // }
//     match minzoom {
//         Some(z) => {
//             debug!("minzoom: {}", z);
