...
class TileType:
    def __init__(
        self, format: TILE_FORMAT_STR, encoding: TILE_ENCODING_STR
    ) -> None: ...
    @property
    def format(self) -> TILE_FORMAT_STR: ...
    @property
    def encoding(self) -> TILE_ENCODING_STR: ...
    @classmethod
